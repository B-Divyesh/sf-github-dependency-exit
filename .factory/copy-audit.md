...
Audited from the rendered `/` route on 2026-08-28. Counts treat hyphenated terms and version strings as one word. Headings, labels, buttons, and fact lines are included because visitors read them as product copy.
